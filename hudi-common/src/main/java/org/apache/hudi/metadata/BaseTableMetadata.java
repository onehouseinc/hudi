...
public abstract class BaseTableMetadata extends AbstractHoodieTableMetadata {
   ...
   */
  @Override
  public Map<String, HoodieRecordGlobalLocation> readRecordIndex(HoodieData<String> recordKeys) {
   ...
   */
  @Override
  public Map<String, HoodieRecordGlobalLocation> readSecondaryIndex(HoodieData<String> secondaryKeys, String partitionName) {
    ...
    Map<String, Set<String>> secondaryKeyRecords = getSecondaryIndexRecords(
        HoodieListData.eager(secondaryKeys.collectAsList()), partitionName);
  ...
  protected abstract Map<String, HoodieRecord<HoodieMetadataPayload>> getRecordsByKeys(HoodieData<String> keys, String partitionName);

  /**
   * Returns a map of (secondary-key -> set-of-record-keys) for the provided secondary keys.
   */
  public abstract Map<String, Set<String>> getSecondaryIndexRecords(HoodieData<String> keys, String partitionName);
